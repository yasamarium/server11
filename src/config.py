...
class Settings:
    ...
    MODEL_NAME: str = os.getenv("MODEL_NAME", "gemma-2-2b")
    MODEL_FILE: str = os.getenv("MODEL_FILE", "gemma-2-2b-it-Q4_K_M.gguf")
    MODEL_PATH: str = os.getenv(
        "MODEL_PATH",
        str(Path(__file__).resolve().parent.parent / "models" / os.getenv("MODEL_FILE", "gemma-2-2b-it-Q4_K_M.gguf")),
    )
    MODEL_URL: str = os.getenv("MODEL_URL", "https://huggingface.co/bartowski/gemma-2-2b-it-GGUF/resolve/main/gemma-2-2b-it-Q4_K_M.gguf")
